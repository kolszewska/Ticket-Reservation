        ...
        <div class=container>
            <form:form action="/confirmReservation/${reservation.screening_id.id}" name="form" method="POST">
                <div class="form-group row">
                    ...
                    <div class="col-xs-10">
                        <input class="form-control" type="text" id="name-input" name="firstName" readonly="readonly"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-10">
                        <input class="form-control" type="search" id="surname-input" name="lastName" readonly="readonly"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-10">
                        <input class="form-control" type="email" id="email-input" name="email" readonly="readonly"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-10">
                        <input class="form-control" type="tel" id="tel-input" name="telephone" readonly="readonly"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-10">
                        <input class="form-control" type="number" id="tickets-number-input" min="1" max="10" readonly="readonly"
                               name="numberOfTickets" value="${reservation.numberOfTickets}">
                    </div>
                </div>
